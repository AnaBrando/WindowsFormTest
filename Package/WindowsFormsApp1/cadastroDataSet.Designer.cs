...
SELECT Id, Nome, Endereco, CEP, Bairro, Cidade, UF, TELEFONE FROM cliente WHERE (Id = @Id)";
        ...
        public virtual int Fill(cadastroDataSet.clienteDataTable dataTable) {
        ...
        public virtual cadastroDataSet.clienteDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            cadastroDataSet.clienteDataTable dataTable = new cadastroDataSet.clienteDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(cadastroDataSet.clienteDataTable dataTable) {
